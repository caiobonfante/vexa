...
Focus: telegram-chat
Problem: services/telegram-bot, packages/agent-api, packages/runtime-api, services/admin-api lack structured README.md with constraints. The conductor can't enforce service boundaries because there's nothing to enforce.
