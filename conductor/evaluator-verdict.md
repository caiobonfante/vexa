...
- Real E2E delivery: bot status change (meeting 30) → bot-manager pipeline → webhook receiver on port 9999
- Bot-manager log: `Webhook delivered to http://172.29.0.1:9999/webhook: 200`
