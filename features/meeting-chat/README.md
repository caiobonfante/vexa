...
|---|-------|--------|---------|-------|--------|----------|--------------|------|
| 1 | POST /chat sends message visible to participants | 30 | ceiling | 0 | UNTESTED | GMeet: POST /chat → 200. Teams: POST /chat → 202. Messages sent during active meeting. | 2026-04-05T21:41Z | 09-verify-transcription |
| 2 | GET /chat returns messages from meeting | 30 | ceiling | 0 | UNTESTED | GMeet: GET /chat → 200, meeting_id=137. Teams: GET /chat → 200, meeting_id=127. BUG #29 FIXED: _find_meeting_any_status() replaces _find_active_meeting() for chat read. | 2026-04-05T22:41Z | 09-verify-transcription |
| 3 | Works on GMeet and Teams | 20 | — | 0 | UNTESTED | GMeet chat read+write works. Teams chat read now works after meeting ends (BUG #29 fixed). | 2026-04-05T22:41Z | 09-verify-transcription |
| 4 | Chat messages persisted after meeting ends | 20 | — | 0 | UNTESTED | GET /chat returns data for completed meetings on both platforms. Redis data accessible via API after BUG #29 fix. | 2026-04-05T22:41Z | 10-verify-post-meeting |
