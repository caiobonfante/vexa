...
| 7 | Dashboard renders REST-loaded transcript on page load | 10 | — | 0 | PASS | FIX: Dashboard skipped REST fetch for active meetings (`shouldUseWebSocket=true` → REST conditional). Changed to always bootstrap from REST. File: `services/dashboard/src/app/meetings/[id]/page.tsx:658`. | 2026-04-07 | dashboard |
