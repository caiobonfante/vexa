...
P0 envelope standardization validated by running code in the rebuilt meeting-api container. End-to-end delivery blocked by SSRF protection (private IPs blocked by design — correct behavior for production).
...
| Status webhook scheduled | 90 | Meeting-api log: "Scheduled status webhook task for meeting 651" | 2026-03-23 (live log) | — |
| Webhook task runner fires | 90 | Meeting-api log: "Starting webhook task runner for meeting 651" | 2026-03-23 (live log) | — |
...
| Durable retry | 80 | Retry worker started in meeting-api logs | 2026-03-23 (live log) | Verify Redis queue on failure |
...
docker exec vexa-restore-meeting-api-1 python3 -c "
